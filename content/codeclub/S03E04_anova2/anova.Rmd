...
## 2. Kruskal Wallis test function
...
### Exercise 1
Conduct ANOVA oto see if there are significant differences in `bill_depth_mm` in the Palmer penguins by `species`.
...
### Extra exercise 1
You want to know if there are significant differences in `bill_depth_mm` in the Palmer penguins by `species`.  Test the assumptions used by ANOVA to see if it is an appropriate test for you to use in this case.  If it is not, find out what the appropriate test to use is, and then use it!
