...
```{r, eval=FALSE}
download.file("https://raw.githubusercontent.com/biodash/biodash.github.io/master/content/codeclub/S05E02/Metabolite.csv")
...
Add a column to `metabolite_long` with the count in units of 1000s
by dividing the count column by 1000,
and name the new variable `count_k`.

Bonus: if you've used `group_by()` and `summarize()` before,
