...
You might notice that *exp_data2* is a tibble, while *exp_data* is a data frame (try the `class()` function on each). This small difference in the types of objects that are returned is one of the differences in the functions `read.table()` and `read_tsv()`. 
