...
_[Tidy Data for reproducibility, efficiency, and_ _collaboration](https://www.openscapes.org/blog/2020/10/12/tidy-data/)_
...
<details><summary><b>Hint 2 after you've pivoted </b>(click here)</summary>
<br>

Note that the year columns are called "<year> Rank" (e.g., `2020 Rank`)
and not just "<year>" (e.g., `2020`).
You can fix this within `pivot_longer()` using `names_transform`.
Visit [this link](https://www.tidyverse.org/blog/2020/05/tidyr-1.1.0/) for some help.
