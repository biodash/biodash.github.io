...
but one trick for now is to set a different _ggplot_ plotting "theme" 
for the rest of your R session:
...
p1 + p2 & theme_minimal(base_size = 12)
```
...
We can improve on a plot like this plot a bit,
