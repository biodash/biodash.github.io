...
<figcaption>Artwork by [@allison_horst](https://twitter.com/allison_horst)</figcaption>
</p>


### A reminder about directories

A couple of weeks ago, Jelmer shared with us some information about [getting and your working directory](https://biodash.github.io/codeclub/s05e05/#interlude-file-locations) using `getwd()` and `setwd()`.
...
* include everything you need to make your code reproducible. That includes any `library()` calls and any necessary objects.
