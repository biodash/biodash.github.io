...
```{r}
# See the first four countries in the list of the time zone
head(OlsonNames(), 4)
```
...
Second, we'll plot the relative relative abundance of different bird orders
by day of the week:
...
Calculate the time differences between the last four countries in the time zone
lists with the current time.
