...
I will start with a very brief overview of the book, of the RStudio interface,
...
what may be most surprising for a book about data science
is that it contains very little material on statistics
...
count with `wc -l` (**w**ord**c**ount -**l**ines),
...
Being aware of this is useful when you run into cases where you want the piped
data to go to say the second or third argument of a function (see the box below).
...
of a function.
But to be more precise, the pipe passes the object to the first _unnamed_
