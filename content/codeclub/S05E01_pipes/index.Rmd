...
Unix pipe (`|`), and is one character typing than `%>%`.
...
This placeholder is useful when the piped data should go to, say,
the second or third argument of a function (see the box below).
...
using the `select()` function to select certain columns,
