...
with all 4 other levels. (However, we can still compare other levels too.)
...
(that looks a bit confusing because this format uses underscores to separate levels,
...
Finally, for a plot like this it could be useful to be able to identify individual
genes. There are way too many to print the gene names on the plot, though.
