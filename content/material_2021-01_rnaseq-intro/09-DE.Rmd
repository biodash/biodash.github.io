...
The interaction term came last in our formula,
so the `results()` function will get results for the interaction term by default:
...
The effect of AMF in "mock" Treatment:
