...
tibble_url <- "https://raw.githubusercontent.com/biodash/biodash.github.io/master/assets/data/Tibbles.Rmd"

Then run:

download.file(tibble_url, "Tibbles.Rmd")
...
The `class()` function is useful when you are jumping back and forth between data frames and tibbles, or to check the structure of a data set you inherit from somewhere else.
...
3. Find three ways to identify the displacement `disp` vector.

4. You also have available a dataset called flights (part of the nycflights13 package we load at the beginning of this file). Is this a tibble or a data frame? How do you know? When it comes to printing this data set why is the distinction particularly important?
